...
const rooms = computed(() => {
  return props.facilities.map(facility => {
    ...
    return {
      ...
      bedType: details['Bed Type'] || 'Double Deck',
      ventilation: details['Ventilation'] || 'Air Conditioned',
      restroom: details['Restroom'] || 'Common',
      allImages: facility.image_urls || [],
      description: 'Welcome to the official hostel of the University of Southeastern Philippines. Our rooms are clean, secure, and ideal for students and guests.'
    }
  })
})
      ...
      router.post('/bookings', formData, {
        onSuccess: () => {
          Swal.fire({
            ...
            text: 'Your hostel booking has been submitted successfully.',
  ...
  <div class="landing-page bg-white text-black min-h-screen font-sans">
    ...
    <section class="px-6 py-12 bg-white">
      ...
      <div v-else class="text-center py-20">
        ...
        <p class="text-gray-500">Check back later for available hostel rooms.</p>
      </div>
    </section>
