  ...
  <div>
    ...
    <section class="bg-white py-20 px-8 text-center">
      <div class="max-w-4xl mx-auto">
        ...
        <img src="/images/parking-cover.png" class="rounded-lg shadow-lg w-full h-80 object-cover hover:scale-105 transition" />
      </div>
    </section>
...
export default {
  ...
  data() {
    return {
      facilities: [
        { name: 'Classroom', image: '/images/classroom.jpg' },
