  ...
  <div class="min-h-screen flex font-sans">
    ...
    <aside class="w-64 bg-[#5F1213] text-white h-screen p-6 fixed top-0 left-0 z-10">
      ...
      <nav class="space-y-4">
        ...
        <!-- Update Dropdown -->
        <div class="group">
          <a href="#" class="flex items-center justify-between gap-3 px-4 py-2 rounded-lg font-medium shadow hover:bg-[#FFA600] hover:text-[#5F1213] transition duration-200 w-full">
        ...
        <div class="group">
          ...
          <div class="hidden group-hover:block ml-6 mt-2 space-y-2">
            <Link href="/admin/report/paytopark" class="block px-4 py-2 text-sm shadow rounded-md bg-[#5F1213] text-white hover:bg-[#FFA600] hover:text-[#5F1213] transition duration-200">Pay-to-Park</Link>
            <a href="#" class="block px-4 py-2 text-sm rounded-md hover:bg-[#FFA600] hover:text-[#5F1213] transition">Online Market</a>
        ...
        <main class="p-8 flex-1 ml-64 bg-[#f5f5f5] min-h-screen">
          <div class="max-w-7xl mx-auto space-y-6">
            ...
            <div class="flex items-center justify-between">
              <h2 class="text-3xl font-bold text-[#5F1213] tracking-wide">Pay-to-Park Logs</h2>
            </div>
