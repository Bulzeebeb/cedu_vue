      ...
      <div class="max-w-6xl mx-auto px-4 space-y-6">
        ...
        <div v-else class="text-center py-12">
          <div v-if="searchQuery">
            <p class="text-gray-500 text-lg">No poultry products found for "{{ searchQuery }}".</p>
            <button
              @click="clearSearch"
          ...
          <p v-else class="text-gray-500 text-lg">No poultry products available at the moment.</p>
        </div>
