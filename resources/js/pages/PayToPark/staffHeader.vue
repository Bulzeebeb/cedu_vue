  ...
  <header class="bg-gradient-to-r from-[#650000] to-[#8b1e1e] text-white shadow-lg sticky top-0 z-50">
    <div class="max-w-screen-xl mx-auto px-6 py-4 flex items-center justify-between">
      ...
      <nav class="hidden md:flex space-x-6 font-medium">
        <button @click="goToHome" class="hover:text-yellow-200 transition">Dashboard</button>
        <button @click="goToCommercial" class="hover:text-yellow-200 transition">Clients</button>
        <button @click="goToHostel" class="hover:text-yellow-200 transition">Reports</button>
        <button @click="goToRental" class="hover:text-yellow-200 transition">History</button>
      </nav>
...
function goToHome() {
  router.visit('/staffdashboardPayToPark')
}
